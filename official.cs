        ...
        private void Display(string text, bool append = true)
        {
            ...
            {
                IMyTextSurface surface = (IMyTextSurface)Info.DisplayCustomer;
                surface.WriteText(text + System.Environment.NewLine, append);
            }
        }
        ...
        private void ShowPrices()
        {
            ...
            IMyTextSurface surface = (IMyTextSurface)Info.DisplayPrice;
            surface.WriteText(priceList);
        }
